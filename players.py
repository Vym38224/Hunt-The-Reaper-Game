...
background_end = Background(("img/background_end.png"))
background_win = Background(("img/background_win.png"))
    
#lidi
player0 = Player("Sam", 1000,("img/human.png"),("img/human2.png"),("img/human_attack.png"),("img/human_attack2.png"))

#kouzelníci
player1 = WizardPlayer("Ganon","fire", 300,("img/firemag.png"),("img/firemag2.png"),("img/fireball.png"),("img/fireball2.png"))

#war
player2 = WizardPlayer("Sorcha", "slunce", 125,("img/watermag.png"),("img/watermag2.png"),("img/watermag_attack.png"),("img/watermag_attack2.png"))

#lukostřelci
player3 = ArcherPlayer("Robin", "bird", 200,("img/archer.png"),("img/archer2.png"),("img/arrow.png"),("img/arrow2.png"))

#enemáci
 
enemy0 = EnemyPlayer("Kostlivec", 1,("img/sceleton.png"),("img/sceleton2.png"))
enemy1 = EnemyPlayer("BOSS Kostlivec", 1,("img/scelet_boss.png"),("img/scelet_boss2.png"))
